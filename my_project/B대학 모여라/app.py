...
def meeting_modify():
    ...
    meetings = db.meeting.find_one({'id': id})

    new_title = meetings['title']
    new_pw = meetings['pw']
    new_place = meetings['place']
    new_time = meetings['time']
    new_desc = meetings['desc']
    new_todo = meetings['todo']
    new_keyword = meetings['keyword']

    db.meeting.update_one({'id': id}, {'$set': {'title': new_title,
                                                'pw': new_pw,
                                                'place': new_place,
                                                'time': new_time,
                                                'desc': new_desc,
